...
<xsl:stylesheet 
    ...
    <xsl:template match="sfd:process/sfd:description|rep:processObject/rep:description|con:connection/con:description|rep:Description|bcm:businessConnector/bcm:description">
        <xsl:copy>
            <xsl:choose> 
